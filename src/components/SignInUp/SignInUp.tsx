    ...
    const middleware = () => {
      ...
      Object.keys(credential).forEach((key: string) => {
        ...
        if (
          ...
          credential[key as keyof typeof credential].isTyping
        ) {
          // console.log(key);
  ...
  const onSignUp = async () => {
    try {
      ...
      if (isAxiosError(err)) {
        ...
        toast.error(
          errorMessages[
            err?.response?.data?.message as keyof typeof errorMessages
          ]
        );
      }
    }
    ...
    <>
      <div className={styles.formContainer}>
        <div className={styles.formLayout}>
          {/* SIGN IN */}
          <div
            className={`${styles.formWrap} ${styles.signIn} ${
              !swapForm ? styles.formActive : ""
            }`}
          >
            ...
            {user.error ? (
              <p>{errorMessages[user.error as keyof typeof errorMessages]}</p>
            ) : null}
            <div className={styles.inputFieldWrapper}>
              <input
                type="password"
          ...
          {/* SIGN UP */}
          <div
            className={`${styles.formWrap} ${styles.signUp} ${
              swapForm ? styles.formActive : ""
            }`}
          >
            ...
            <div className={styles.inputFieldWrapper}>
              <input
                ...
                placeholder="Username"
                className={`${styles.inputField} ${
                  errors.username ? styles.inputFieldError : null
                }`}
            ...
            <div className={styles.inputFieldWrapper}>
              <input
                ...
                placeholder="Password"
                className={`${styles.inputField} ${
                  errors.password ? styles.inputFieldError : null
                }`}
            ...
            <div className={styles.inputFieldWrapper}>
              <input
                ...
                className={`${styles.inputField} ${
                  errors.confirmPassword ? styles.inputFieldError : null
                }`}
            ...
            <div className={styles.inputFieldWrapper}>
              <input
                ...
                className={`${styles.inputField} ${
                  errors.fullName ? styles.inputFieldError : null
                }`}
          ...
          {/* Intro */}
          <div
            className={`${styles.introduce} ${swapForm ? styles.active : ""}`}
          >
            <div>
              <div
                className={`${styles.signUpIntroduce} ${
                  !swapForm ? styles.introduceActive : ""
                }`}
              >
                <p className={styles.introHeader}>Hello Friends !</p>
                <button
                  onClick={handleSwap}
                  className={`${styles.button} ${styles.introBtn}`}
                >
                  SIGN UP
                </button>
              </div>
              <div
                className={`${styles.signInIntroduce} ${
                  swapForm ? styles.introduceActive : ""
                }`}
              >
